...
class TeXViewServer {
  ...
  Future<void> close() async {
    if (this._httpServer != null) {
      ...
      await this._wsHttpServer.close(force: true);
      print('Server running on http://localhost:$_wsPort closed');
      this._httpServer = null;
      this._wsHttpServer = null;
    }
  }

  ///Starts the server
  Future<void> start(Function(HttpRequest request) request,
      Function(WebSocket) webSocket) async {
    if (this._httpServer != null) {
