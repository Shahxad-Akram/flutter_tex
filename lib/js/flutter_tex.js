...
function createTeXViewGroup(groupElement, groupData) {
    var data = groupData['data'];
    var rippleEffect = groupData['rippleEffect'];
    var normalStyle = groupData['normalItemStyle'];
    var selectedStyle = groupData['selectedItemStyle'];
    var lastSelected;
...
function pageLoaded() {
    try {
        // noinspection JSUnresolvedVariable
        TeXViewCreatedCallback.postMessage("Page has been loaded...!");
    } catch (e) {
